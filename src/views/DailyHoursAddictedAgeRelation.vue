<template>
  <div>
    <h1>Daily Hours Addicted Age Relation</h1>
    ...
    <div class="mt-4">
      <img
        ...
        alt="Daily Hours Addicted Age Relation Plot"
    ...
    <button @click="fetchRelation" class="mt-4 bg-blue-500 text-white px-4 py-2 rounded">
      Generar Relación
    </button>
  </div>
</template>
